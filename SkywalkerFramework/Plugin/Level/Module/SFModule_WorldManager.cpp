/*************************************************************************
**文件: SkywalkerFramework\Plugin\Level\Module\SFModule_WorldManager.cpp
**作者: shyfan
**日期: 2026/03/02
**功能: 世界管理模块
*************************************************************************/

#include "SFModule_WorldManager.h"
...
SF_LOG_DEFINE(SFModule_WorldManager, ESFLogLevel::Debug);

void SFModule_WorldManager::Init(SFObjectErrors &Errors)
{
...
void SFModule_WorldManager::Start(SFObjectErrors &Errors)
{
...
void SFModule_WorldManager::Stop(SFObjectErrors &Errors)
{
...
void SFModule_WorldManager::Destroy(SFObjectErrors &Errors)
{
...
bool SFModule_WorldManager::CreateWorld(SFUInt64 WorldId)
{
    if (WorldId == 0)
    {
        return false;
...
bool SFModule_WorldManager::EnterWorld(SFUInt64 PlayerId, SFUInt64 WorldId)
{
...
bool SFModule_WorldManager::LeaveWorld(SFUInt64 PlayerId, SFUInt64 WorldId)
{
    if (PlayerId == 0 || WorldId == 0)
    {
        return false;
...
SFUInt64 SFModule_WorldManager::GetWorldPlayerCount(SFUInt64 WorldId) const
{
