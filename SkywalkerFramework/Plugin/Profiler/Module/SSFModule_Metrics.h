/*************************************************************************
**文件: SkywalkerFramework\Plugin\Profiler\Module\SSFModule_Metrics.h
**作者: shyfan
**日期: 2026/03/02
**功能: 指标采集模块
*************************************************************************/
...
class SSFModule_Metrics : public SSFModule
{
...
public:
    SSFModule_Metrics(SFModuleContext &InContext, SFObjectErrors &InErrors)
        : SSFModule(InContext, InErrors)
    {
    }
    virtual ~SSFModule_Metrics() {};
