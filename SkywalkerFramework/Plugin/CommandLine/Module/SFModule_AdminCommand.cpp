/*************************************************************************
**文件: SkywalkerFramework\Plugin\CommandLine\Module\SFModule_AdminCommand.cpp
**作者: shyfan
**日期: 2026/03/02
**功能: 管理命令模块
*************************************************************************/

#include "SFModule_AdminCommand.h"
...
SF_LOG_DEFINE(SFModule_AdminCommand, ESFLogLevel::Debug);

void SFModule_AdminCommand::Init(SFObjectErrors &Errors)
{
...
void SFModule_AdminCommand::Destroy(SFObjectErrors &Errors)
{
...
bool SFModule_AdminCommand::ExecuteCommand(const SFString &CommandLine)
{
...
bool SFModule_AdminCommand::ParseRoleAndCommand(const SFString &CommandLine, SFString &OutRole, SFString &OutResolvedCommandLine) const
{
    OutRole = "admin";
...
bool SFModule_AdminCommand::HasPermission(const SFString &Role, const SFString &Command) const
{
    if (Role == "admin")
    {
        return true;
...
void SFModule_AdminCommand::ResetDefaultACL()
{
    AdminOnlyCommands = {
        "reload_config",
        "reload_acl",
...
bool SFModule_AdminCommand::ReloadACLFromConfig()
{
...
void SFModule_AdminCommand::ApplyCommandsFromConfig(const SFString &RawValue, std::unordered_set<SFString> &CommandSet)
{
    if (RawValue.empty())
    {
        return;
...
SFUInt64 SFModule_AdminCommand::GetAuditItemCount(const SFString &AuditText) const
{
    if (AuditText.empty() ||
