/*************************************************************************
**文件: SkywalkerFramework\Plugin\Video\SFPlugin_Video.h
**作者: shyfan
...
class SFPlugin_Video : public SFPlugin
{
public:
    SFPlugin_Video(SFPluginContext &InContext, SFObjectErrors &InErrors)
        : SFPlugin(InContext, InErrors)
    {
    }
    virtual ~SFPlugin_Video() {};
