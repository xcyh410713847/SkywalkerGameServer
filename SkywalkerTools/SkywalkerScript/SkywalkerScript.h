/*************************************************************************
**文件: SkywalkerTools\SkywalkerScript\SkywalkerScript.h
**作者: shyfan
**日期: 2023/08/29 14:56:55
**功能: Skywalker Script 解析器
*************************************************************************/

#ifndef __SKYWALKER_SCRIPT_H__
#define __SKYWALKER_SCRIPT_H__
...
#define SKYWALKER_SCRIPT_NAMESPACE_USING using namespace SKYWALKER_SCRIPT_NAMESPACE;
...
/** 脚本解析器指针类型 */
#define SKYWALKER_SCRIPT_PTR(T) SKYWALKER_SCRIPT_NAMESPACE::T *
/** 脚本解析器智能指针 */
